...
@Component({
  ...
  templateUrl: './vivienda-vis.component.html',
  styleUrls: ['./vivienda-vis.component.css']
})
export class ViviendaVisComponent implements OnInit {
  ...
  async getData() {
    this.data = await this.pageService.getContentPage('proyectos-construccion-vivienda-vis')
  }
  ...
  async getImagenes() {
    this.imagenes = await this.pageService.getImagesBySlugPage('proyectos-construccion-vivienda-vis');
