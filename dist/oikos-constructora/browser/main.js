...
const routes = [
    ...
    {
        path: 'contactenos',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_contact_contact_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./modules/contact/contact.module */ 3033)).then(m => m.ContactModule)
    },
    {
        path: 'gracias/:slug',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_modules_thanks_thanks_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/thanks/thanks.module */ 7411)).then(m => m.ThanksModule)
    },
    {
        path: 'noticias',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_modules_blog_blog_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/blog/blog.module */ 6195)).then(m => m.BlogModule)
    },
    {
        path: 'proyectos-construccion-vivienda',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_modules_projects_vivienda_vivienda_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/projects/vivienda/vivienda.module */ 5500)).then(m => m.ViviendaModule)
    },
    {
        path: 'proyecto/:slug',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_modules_projects_interna_interna_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/projects/interna/interna.module */ 7540)).then(m => m.InternaModule)
    }, {
        path: 'legales/:slug',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_modules_legales_legales_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./modules/legales/legales.module */ 3304)).then(m => m.LegalesModule)
    }, {
        path: '**',
...
class PageService {
  ...
  getBreadCrumb(slug) {
    ...
    return (0,_home_jeiobaco_codes_company_projects_paxzu_oikos_oikos_contructora_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return _this6._http.get(url).toPromise().then();
    })();
  }
...
PageService.ɵfac = function PageService_Factory(t) {
  return new (t || PageService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient));
};

PageService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
  token: PageService,
